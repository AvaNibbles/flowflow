...
// Default flowflowclient HTTP client.
...
// NewHTTPClient creates a new flowflowclient HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Flowflowclient {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new flowflowclient HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Flowflowclient {
...
// New creates a new flowflowclient client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Flowflowclient {
	// ensure nullable parameters have default
	if formats == nil {

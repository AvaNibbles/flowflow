...
// NewGetAPIV1HackErrCodeParams creates a new GetAPIV1HackErrCodeParams object,
...
func NewGetAPIV1HackErrCodeParams() *GetAPIV1HackErrCodeParams {
	return &GetAPIV1HackErrCodeParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetAPIV1HackErrCodeParamsWithTimeout creates a new GetAPIV1HackErrCodeParams object
...
// NewGetAPIV1HackErrCodeParamsWithContext creates a new GetAPIV1HackErrCodeParams object
...
// NewGetAPIV1HackErrCodeParamsWithHTTPClient creates a new GetAPIV1HackErrCodeParams object
...
/* GetAPIV1HackErrCodeParams contains all the parameters to send to the API endpoint
   for the get API v1 hack err code operation.

   Typically these are written to a http.Request.
*/
type GetAPIV1HackErrCodeParams struct {
...
func (o *GetAPIV1HackErrCodeParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param code
	if err := r.SetPathParam("code", swag.FormatInt64(o.Code)); err != nil {
		return err
	}
